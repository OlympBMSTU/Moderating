...
var author$project$Struct$Model = F3(
	function (token, exercise, navbarState) {
		return {exercise: exercise, navbarState: navbarState, token: token};
	});
var author$project$Struct$NavbarMsg = function (a) {
	return {$: 'NavbarMsg', a: a};
};
var author$project$Struct$StructMsg = function (a) {
	return {$: 'StructMsg', a: a};
};
var author$project$View$OlympStruct$Model = F6(
	function (token, subjects, struct, modalVisibility, subject, grade) {
		return {grade: grade, modalVisibility: modalVisibility, struct: struct, subject: subject, subjects: subjects, token: token};
	});
...
var author$project$Data$Responce$Responce = F3(
	function (a, b, c) {
		return {$: 'Responce', a: a, b: b, c: c};
	});
...
var author$project$Data$Responce$decodeResponce = function (decoder) {
	return A4(
		elm$json$Json$Decode$map3,
		author$project$Data$Responce$Responce,
		A2(
...
var author$project$API$getSubjects = function (token) {
	return elm$http$Http$request(
		{
			body: elm$http$Http$emptyBody,
			expect: elm$http$Http$expectJson(
				author$project$Data$Responce$decodeResponce(
...
var author$project$View$OlympStruct$GetSubjects = function (a) {
	return {$: 'GetSubjects', a: a};
};
...
var author$project$View$OlympStruct$getSubjects = function (token) {
	return A2(
		elm$core$Platform$Cmd$map,
		author$project$View$OlympStruct$GetSubjects,
		krisajenkins$remotedata$RemoteData$sendRequest(
			author$project$API$getSubjects(token)));
};
...
var author$project$View$OlympStruct$init = function (token) {
	return _Utils_Tuple2(
		A6(author$project$View$OlympStruct$Model, token, krisajenkins$remotedata$RemoteData$NotAsked, krisajenkins$remotedata$RemoteData$NotAsked, rundis$elm_bootstrap$Bootstrap$Modal$hidden, '', ''),
		author$project$View$OlympStruct$getSubjects(token));
};
...
var author$project$Struct$init = function (flags) {
	var token = flags.token;
	var _n0 = rundis$elm_bootstrap$Bootstrap$Navbar$initialState(author$project$Struct$NavbarMsg);
	var navbarState = _n0.a;
	var navbarCmd = _n0.b;
	var _n1 = author$project$View$OlympStruct$init(token);
	var exerciseModel = _n1.a;
	var exerciseCmd = _n1.b;
	return _Utils_Tuple2(
		A3(author$project$Struct$Model, token, exerciseModel, navbarState),
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(elm$core$Platform$Cmd$map, author$project$Struct$StructMsg, exerciseCmd),
					navbarCmd
				])));
};
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$View$OlympStruct$subscriptions = function (model) {
...
var author$project$Struct$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(rundis$elm_bootstrap$Bootstrap$Navbar$subscriptions, model.navbarState, author$project$Struct$NavbarMsg),
				A2(
				elm$core$Platform$Sub$map,
				author$project$Struct$StructMsg,
				author$project$View$OlympStruct$subscriptions(model.exercise))
			]));
};
	...
	function (resp, x) {
		switch (resp.$) {
			case 'Success':
				...
				var msg = _n1.b;
				var status = _n1.c;
				return A2(elm$core$Debug$log, msg, x);
			case 'Failure':
				var err = resp.a;
				return A2(elm$core$Debug$log, 'elm error', x);
			default:
				return x;
		}
	});
...
var author$project$Data$Responce$mapResponce = function (resp) {
	var f = function (_n2) {
		var x = _n2.a;
		return x;
	};
	var mdata = A2(krisajenkins$remotedata$RemoteData$map, f, resp);
	var data = function () {
		switch (mdata.$) {
			case 'Success':
				if (mdata.a.$ === 'Just') {
					...
					var _n1 = mdata.a;
					return krisajenkins$remotedata$RemoteData$Failure(elm$http$Http$NetworkError);
				}
			case 'NotAsked':
				return krisajenkins$remotedata$RemoteData$NotAsked;
			case 'Failure':
...
var author$project$Data$OlympStruct$OlympStruct = F2(
	function (exs, perExs) {
		return {exs: exs, perExs: perExs};
	});
var author$project$Data$OlympStruct$decodeOlympStruct = A3(
	elm$json$Json$Decode$map2,
	author$project$Data$OlympStruct$OlympStruct,
	A2(
		elm$json$Json$Decode$field,
		'exs',
	...
	A2(
		...
		'per_exs',
		elm$json$Json$Decode$list(elm$json$Json$Decode$int)));
var author$project$API$getOlympStruct = F3(
	function (subject, grade, token) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$emptyBody,
				expect: elm$http$Http$expectJson(
					author$project$Data$Responce$decodeResponce(author$project$Data$OlympStruct$decodeOlympStruct)),
				headers: author$project$API$mkTokenHeader(token),
				method: 'GET',
				timeout: elm$core$Maybe$Nothing,
				url: 'https://olymp.bmstu.ru/api/testing/olymp_conf?subject=' + (subject + ('&grade=' + grade)),
				withCredentials: true
			});
	});
var author$project$View$OlympStruct$GetStruct = function (a) {
	return {$: 'GetStruct', a: a};
};
var author$project$View$OlympStruct$getOlympStruct = F3(
	function (subject, grade, token) {
		return A2(
			elm$core$Platform$Cmd$map,
			author$project$View$OlympStruct$GetStruct,
			krisajenkins$remotedata$RemoteData$sendRequest(
				A3(author$project$API$getOlympStruct, subject, grade, token)));
	});
var elm$json$Json$Encode$int = _Json_wrap;
var author$project$Data$OlympStruct$encodeOlympStruct = function (ex) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'exs',
				elm$json$Json$Encode$list(elm$json$Json$Encode$int)(ex.exs)),
				_Utils_Tuple2(
				'per_exs',
				elm$json$Json$Encode$list(elm$json$Json$Encode$int)(ex.perExs))
			]));
};
...
var author$project$API$postOlympStruct = F4(
	function (os, subject, grade, token) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$jsonBody(
					author$project$Data$OlympStruct$encodeOlympStruct(os)),
				expect: A3(
					elm$core$Basics$composeL,
...
var author$project$View$OlympStruct$PostStruct = function (a) {
	return {$: 'PostStruct', a: a};
};
var author$project$View$OlympStruct$postOlympStruct = F4(
	function (os, subject, grade, token) {
		return A2(
			elm$core$Platform$Cmd$map,
			author$project$View$OlympStruct$PostStruct,
			krisajenkins$remotedata$RemoteData$sendRequest(
				A4(author$project$API$postOlympStruct, os, subject, grade, token)));
	});
...
var author$project$View$OlympStruct$update = F2(
	function (msg, model) {
		return A2(
			elm$core$Debug$log,
			'update',
			function () {
				switch (msg.$) {
						...
						return A2(
							...
							_Utils_Tuple2(
								_Utils_update(
									model,
									{
										subjects: author$project$Data$Responce$mapResponce(resp)
									}),
								elm$core$Platform$Cmd$none));
					case 'GetStruct':
						var resp = msg.a;
						return A2(
							...
							_Utils_Tuple2(
								_Utils_update(
									model,
									{
										struct: author$project$Data$Responce$mapResponce(resp)
									}),
								elm$core$Platform$Cmd$none));
					case 'SubjectSelect':
						var subject = msg.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{struct: krisajenkins$remotedata$RemoteData$NotAsked, subject: subject}),
							((model.grade === '') || (subject === '')) ? elm$core$Platform$Cmd$none : A3(author$project$View$OlympStruct$getOlympStruct, subject, model.grade, model.token));
					case 'GradeSelect':
						var grade = msg.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{grade: grade, struct: krisajenkins$remotedata$RemoteData$NotAsked}),
							((grade === '') || (model.subject === '')) ? elm$core$Platform$Cmd$none : A3(author$project$View$OlympStruct$getOlympStruct, model.subject, grade, model.token));
					case 'UpdateStruct':
						var _n1 = model.struct;
						if (_n1.$ === 'Success') {
							var struct = _n1.a;
							var check20 = A2(
								elm_community$list_extra$List$Extra$zip,
								A2(elm$core$List$take, 3, struct.exs),
								A2(elm$core$List$take, 3, struct.perExs));
							var check21 = elm$core$List$sum(
								A2(
									elm$core$List$map,
									function (_n2) {
										var a = _n2.a;
									...
									check20));
							var check2 = _Utils_eq(
								elm$core$Maybe$Just(check21),
								A2(elm_community$list_extra$List$Extra$getAt, 3, struct.perExs));
							var check1 = _Utils_eq(
								elm$core$Maybe$Just(
									elm$core$List$sum(
										A2(elm$core$List$take, 3, struct.exs))),
								A2(elm_community$list_extra$List$Extra$getAt, 3, struct.exs));
							return ((!check1) || (!check2)) ? _Utils_Tuple2(
								_Utils_update(
									model,
									{modalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$shown}),
								elm$core$Platform$Cmd$none) : _Utils_Tuple2(
								model,
								A4(author$project$View$OlympStruct$postOlympStruct, struct, model.subject, model.grade, model.token));
						} else {
							return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
						}
					case 'InputPoints':
						var i = msg.a;
						var sp = msg.b;
						var _n3 = model.struct;
						if (_n3.$ === 'Success') {
							var struct = _n3.a;
							var cp = A2(
								elm$core$Maybe$withDefault,
								0,
								A2(elm_community$list_extra$List$Extra$getAt, i, struct.perExs));
							var p = A2(
								elm$core$Maybe$withDefault,
								cp,
								elm$core$String$toInt(sp));
							var updatedp = A3(elm_community$list_extra$List$Extra$setAt, i, p, struct.perExs);
							var us = _Utils_update(
								struct,
								{perExs: updatedp});
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										struct: krisajenkins$remotedata$RemoteData$Success(us)
									}),
								elm$core$Platform$Cmd$none);
						} else {
							return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					...
					case 'InputCount':
						var i = msg.a;
						var sp = msg.b;
						var _n4 = model.struct;
						if (_n4.$ === 'Success') {
							var struct = _n4.a;
							var cp = A2(
								elm$core$Maybe$withDefault,
								0,
								A2(elm_community$list_extra$List$Extra$getAt, i, struct.exs));
							var p = A2(
								elm$core$Maybe$withDefault,
								cp,
								elm$core$String$toInt(sp));
							var updatedp = A3(elm_community$list_extra$List$Extra$setAt, i, p, struct.exs);
							var us = _Utils_update(
								struct,
								{exs: updatedp});
							return _Utils_Tuple2(
...
var author$project$Struct$update = F2(
	function (msg, model) {
		if (msg.$ === 'StructMsg') {
			var vmsg = msg.a;
			var _n1 = A2(author$project$View$OlympStruct$update, vmsg, model.exercise);
			var updatedStruct = _n1.a;
			var cmd = _n1.b;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{exercise: updatedStruct}),
				A2(elm$core$Platform$Cmd$map, author$project$Struct$StructMsg, cmd));
		} else {
			var state = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
...
var author$project$Struct$viewNavbar = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				A3(
					...
					_List_fromArray(
						[
							elm$html$Html$text(' Модерирование')
						]),
					rundis$elm_bootstrap$Bootstrap$Navbar$withAnimation(
						rundis$elm_bootstrap$Bootstrap$Navbar$config(author$project$Struct$NavbarMsg))))
			]));
};
var author$project$View$OlympStruct$CloseModal = {$: 'CloseModal'};
var author$project$View$OlympStruct$GradeSelect = function (a) {
...
var author$project$View$OlympStruct$viewGradeSelect = function (model) {
	var mkSelect = function (i) {
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					elm$core$String$fromInt(i) + ' класс')
				]));
	};
	var allSelect = _List_fromArray(
		[
			A2(
			rundis$elm_bootstrap$Bootstrap$Form$Select$item,
			_List_Nil,
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rundis$elm_bootstrap$Bootstrap$Form$Select$onChange(author$project$View$OlympStruct$GradeSelect)
							]),
						_Utils_ap(
							allSelect,
							A2(
								elm$core$List$map,
								mkSelect,
								A2(elm$core$List$range, 5, 11))))
					]))
			]));
};
var author$project$View$OlympStruct$SubjectSelect = function (a) {
	return {$: 'SubjectSelect', a: a};
};
var author$project$View$OlympStruct$viewSubjectSelect = function (model) {
	var mkSelect = function (s) {
		return A2(
			rundis$elm_bootstrap$Bootstrap$Form$Select$item,
			_List_Nil,
			_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rundis$elm_bootstrap$Bootstrap$Form$Select$onChange(author$project$View$OlympStruct$SubjectSelect)
							]),
						_Utils_ap(
							allSelect,
							A2(elm$core$List$map, mkSelect, list)))
					]))
			]));
};
var author$project$View$OlympStruct$UpdateStruct = {$: 'UpdateStruct'};
var author$project$View$OlympStruct$InputCount = F2(
	function (a, b) {
		return {$: 'InputCount', a: a, b: b};
	});
var author$project$View$OlympStruct$InputPoints = F2(
	function (a, b) {
		return {$: 'InputPoints', a: a, b: b};
	});
...
var author$project$View$OlympStruct$viewStruct = F2(
						...
						[
							...
							_List_fromArray(
								[
									...
									author$project$View$OlympStruct$InputPoints(i))
								]))
						]));
			});
		var mkCellCount = F2(
						...
						[
							...
							_List_fromArray(
								[
									...
									elm$core$String$fromInt(value)),
									rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(
									author$project$View$OlympStruct$InputCount(i))
								]))
						]));
			});
							...
							_Utils_ap(
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Количество заданий')
											]))
									]),
								A2(elm$core$List$indexedMap, mkCellCount, struct.exs))),
							A2(
							rundis$elm_bootstrap$Bootstrap$Table$tr,
							_List_Nil,
							_Utils_ap(
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Баллы за задания раздела')
											]))
									]),
								A2(elm$core$List$indexedMap, mkCellPoint, struct.perExs)))
						])),
				thead: rundis$elm_bootstrap$Bootstrap$Table$simpleThead(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('1 Сложность')
								])),
							A2(
							rundis$elm_bootstrap$Bootstrap$Table$th,
							_List_Nil,
							_List_fromArray(
								[
									elm$html$Html$text('2 Сложность')
								])),
							A2(
							rundis$elm_bootstrap$Bootstrap$Table$th,
							_List_Nil,
							_List_fromArray(
								[
									elm$html$Html$text('3 Сложность')
								])),
							A2(
							rundis$elm_bootstrap$Bootstrap$Table$th,
							_List_Nil,
...
var author$project$View$OlympStruct$viewWStruct = function (model) {
	var _n0 = model.struct;
	switch (_n0.$) {
		case 'NotAsked':
			return elm$html$Html$text('Выберите категорию');
		case 'Loading':
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						A2(author$project$View$OlympStruct$viewStruct, model, struct),
						A2(
						rundis$elm_bootstrap$Bootstrap$Button$button,
						_List_fromArray(
							[
								rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$View$OlympStruct$UpdateStruct)
							]),
						_List_fromArray(
							[
...
var author$project$View$OlympStruct$view = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$View$OlympStruct$viewSubjectSelect(model),
								author$project$View$OlympStruct$viewGradeSelect(model)
							])),
						A2(
						rundis$elm_bootstrap$Bootstrap$Grid$col,
						_List_fromArray(
						...
						_List_fromArray(
							[
								author$project$View$OlympStruct$viewWStruct(model)
							]))
					])),
				A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Events$onClick(author$project$View$OlympStruct$CloseModal)
										]))
								]),
							_List_fromArray(
								[
					...
					A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('Данные некорректны')
									]))
							]),
						A3(
							...
							A2(
								...
								rundis$elm_bootstrap$Bootstrap$Modal$small(
									rundis$elm_bootstrap$Bootstrap$Modal$config(author$project$View$OlympStruct$CloseModal)))))))
			]));
};
...
var author$project$Struct$view = function (model) {
	return {
		body: _List_fromArray(
			[
				author$project$Struct$viewNavbar(model),
				A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$map,
						author$project$Struct$StructMsg,
						author$project$View$OlympStruct$view(model.exercise))
					]))
			]),
		title: 'Модерирование'
	};
...
var author$project$Struct$main = elm$browser$Browser$document(
	{init: author$project$Struct$init, subscriptions: author$project$Struct$subscriptions, update: author$project$Struct$update, view: author$project$Struct$view});
_Platform_export({'Struct':{'init':author$project$Struct$main(
	A2(
		elm$json$Json$Decode$andThen,
		function (token) {
			return elm$json$Json$Decode$succeed(
		...
		A2(elm$json$Json$Decode$field, 'token', elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.0"},"types":{"message":"Struct.Msg","aliases":{"Data.OlympStruct.OlympStruct":{"args":[],"type":"{ exs : List.List Basics.Int, perExs : List.List Basics.Int }"},"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"},"Bootstrap.Navbar.VisibilityState":{"args":[],"type":"{ visibility : Bootstrap.Navbar.Visibility, height : Maybe.Maybe Basics.Float, windowWidth : Maybe.Maybe Basics.Float, dropdowns : Dict.Dict String.String Bootstrap.Navbar.DropdownStatus }"},"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"}},"unions":{"Struct.Msg":{"args":[],"tags":{"StructMsg":["View.OlympStruct.Msg"],"NavbarMsg":["Bootstrap.Navbar.State"]}},"View.OlympStruct.Msg":{"args":[],"tags":{"GetSubjects":["RemoteData.WebData (Data.Responce.Responce (List.List String.String))"],"GetStruct":["RemoteData.WebData (Data.Responce.Responce Data.OlympStruct.OlympStruct)"],"PostStruct":["RemoteData.WebData ()"],"UpdateStruct":[],"SubjectSelect":["String.String"],"GradeSelect":["String.String"],"InputCount":["Basics.Int","String.String"],"InputPoints":["Basics.Int","String.String"],"CloseModal":[]}},"Bootstrap.Navbar.State":{"args":[],"tags":{"State":["Bootstrap.Navbar.VisibilityState"]}},"Data.Responce.Responce":{"args":["a"],"tags":{"Responce":["Maybe.Maybe a","String.String","String.String"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Loading":[],"Failure":["e"],"Success":["a"]}},"Bootstrap.Navbar.DropdownStatus":{"args":[],"tags":{"Open":[],"ListenClicks":[],"Closed":[]}},"Bootstrap.Navbar.Visibility":{"args":[],"tags":{"Hidden":[],"StartDown":[],"AnimatingDown":[],"StartUp":[],"AnimatingUp":[],"Shown":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));