				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://olymp.bmstu.ru/exercises/login/')
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://olymp.bmstu.ru/exercises/upload/')
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://olymp.bmstu.ru/exercises/moder/')
								]),
							_List_fromArray(
								[
				...
				thead: rundis$elm_bootstrap$Bootstrap$Table$simpleThead(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('Базовая Сложность')
								])),
							A2(
							rundis$elm_bootstrap$Bootstrap$Table$th,
							_List_Nil,
							_List_fromArray(
								[
									elm$html$Html$text('Продвинутая Сложность')
								])),
							A2(
							rundis$elm_bootstrap$Bootstrap$Table$th,
							_List_Nil,
							_List_fromArray(
								[
									elm$html$Html$text('Сложная Сложность')
								])),
							A2(
							rundis$elm_bootstrap$Bootstrap$Table$th,
							_List_Nil,
