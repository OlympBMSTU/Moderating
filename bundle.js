...
var author$project$Moder$ExerciseMsg = function (a) {
	return {$: 'ExerciseMsg', a: a};
};
var author$project$Moder$Model = F3(
...
var author$project$View$Exercise$Model = function (token) {
	return function (subjects) {
		return function (subject) {
			return function (exercise) {
				return function (modalVisibility) {
					return function (tagString) {
						return function (level) {
							return function (s) {
								return function (g) {
									return function (modalMessage) {
										return {exercise: exercise, g: g, level: level, modalMessage: modalMessage, modalVisibility: modalVisibility, s: s, subject: subject, subjects: subjects, tagString: tagString, token: token};
									};
								};
							};
						};
...
var author$project$View$Exercise$GetSubjects = function (a) {
...
var author$project$View$Exercise$getSubjects = function (token) {
	return A2(
...
var author$project$View$Exercise$init = function (token) {
	return _Utils_Tuple2(
		author$project$View$Exercise$Model(token)(krisajenkins$remotedata$RemoteData$NotAsked)(krisajenkins$remotedata$RemoteData$NotAsked)(krisajenkins$remotedata$RemoteData$NotAsked)(rundis$elm_bootstrap$Bootstrap$Modal$hidden)('')(elm$core$Maybe$Nothing)('')('')(''),
...
var author$project$Moder$init = function (flags) {
	var token = flags.token;
	var _n0 = rundis$elm_bootstrap$Bootstrap$Navbar$initialState(author$project$Moder$NavbarMsg);
	var navbarState = _n0.a;
	var navbarCmd = _n0.b;
	var _n1 = author$project$View$Exercise$init(token);
	var exerciseModel = _n1.a;
	var exerciseCmd = _n1.b;
	return _Utils_Tuple2(
		A3(author$project$Moder$Model, token, exerciseModel, navbarState),
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2(elm$core$Platform$Cmd$map, author$project$Moder$ExerciseMsg, exerciseCmd),
					navbarCmd
				])));
};
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$View$Exercise$subscriptions = function (model) {
...
var author$project$Moder$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(rundis$elm_bootstrap$Bootstrap$Navbar$subscriptions, model.navbarState, author$project$Moder$NavbarMsg),
				A2(
				elm$core$Platform$Sub$map,
				author$project$Moder$ExerciseMsg,
				author$project$View$Exercise$subscriptions(model.exercise))
			]));
};
...
var author$project$Data$Exercise$cleanTags = function (ex) {
	return _Utils_update(
		ex,
		{
...
var author$project$Data$Exercise$decodeExercise = A8(
	elm$json$Json$Decode$map7,
	author$project$Data$Exercise$Exercise,
		...
		return elm$http$Http$request(
			{
				body: elm$http$Http$emptyBody,
				expect: elm$http$Http$expectJson(
					author$project$Data$Responce$decodeResponce(author$project$Data$Exercise$decodeExercise)),
				headers: author$project$API$mkTokenHeader(token),
				method: 'GET',
				timeout: elm$core$Maybe$Nothing,
				url: 'https://olymp.bmstu.ru/api/exercises/get/' + elm$core$String$fromInt(id),
				withCredentials: true
			});
	});
var author$project$View$Exercise$GetExercise = function (a) {
	return {$: 'GetExercise', a: a};
};
var author$project$View$Exercise$getExercise = F2(
	function (id, token) {
		return A2(
			elm$core$Platform$Cmd$map,
			author$project$View$Exercise$GetExercise,
			krisajenkins$remotedata$RemoteData$sendRequest(
				A2(author$project$API$getExercise, id, token)));
	});
var author$project$Data$ExerciseFromSubject$ExerciseFromSubject = F7(
...
var author$project$Data$ExerciseFromSubject$decodeExerciseFromSubject = A8(
	elm$json$Json$Decode$map7,
	author$project$Data$ExerciseFromSubject$ExerciseFromSubject,
	A2(elm$json$Json$Decode$field, 'Id', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'AuthorId', elm$json$Json$Decode$int),
		...
		return elm$http$Http$request(
			{
				...
				expect: elm$http$Http$expectJson(
					author$project$Data$Responce$decodeResponce(
						elm$json$Json$Decode$list(author$project$Data$ExerciseFromSubject$decodeExerciseFromSubject))),
				headers: author$project$API$mkTokenHeader(token),
				method: 'GET',
				timeout: elm$core$Maybe$Nothing,
...
var author$project$View$Exercise$GetSubject = function (a) {
	return {$: 'GetSubject', a: a};
};
var author$project$View$Exercise$getSubject = F3(
	function (grade, subject, token) {
		return A2(
			elm$core$Platform$Cmd$map,
...
var author$project$View$Exercise$PostExercise = function (a) {
	return {$: 'PostExercise', a: a};
};
var author$project$View$Exercise$postExercise = F2(
	function (ex, token) {
		return A2(
			elm$core$Platform$Cmd$map,
			author$project$View$Exercise$PostExercise,
			krisajenkins$remotedata$RemoteData$sendRequest(
					...
					case 'PostExercise':
						if (msg.a.$ === 'Success') {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{modalMessage: 'Ok', modalVisibility: rundis$elm_bootstrap$Bootstrap$Modal$shown}),
...
var author$project$Moder$update = F2(
	function (msg, model) {
		if (msg.$ === 'ExerciseMsg') {
			var vmsg = msg.a;
			var _n1 = A2(author$project$View$Exercise$update, vmsg, model.exercise);
			var updatedExercise = _n1.a;
			var cmd = _n1.b;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{exercise: updatedExercise}),
				A2(elm$core$Platform$Cmd$map, author$project$Moder$ExerciseMsg, cmd));
		} else {
			var state = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
...
var author$project$Moder$viewNavbar = function (model) {
	return A2(
				...
				A2(
					...
					A3(
						...
						rundis$elm_bootstrap$Bootstrap$Navbar$withAnimation(
							rundis$elm_bootstrap$Bootstrap$Navbar$config(author$project$Moder$NavbarMsg)))))
			]));
};
...
var author$project$View$Exercise$viewExerciseList = function (model) {
	...
	var currentExId = function () {
		var _n0 = model.exercise;
		if (_n0.$ === 'Success') {
			var ex = _n0.a;
			return elm$core$Maybe$Just(ex.id);
		} else {
			return elm$core$Maybe$Nothing;
		}
	}();
...
var author$project$View$Exercise$viewGradeSelect = function (model) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rundis$elm_bootstrap$Bootstrap$Form$Select$onChange(author$project$View$Exercise$GradeSelect)
							]),
						_Utils_ap(
							allSelect,
							A2(
...
var author$project$View$Exercise$SubjectSelect = function (a) {
	return {$: 'SubjectSelect', a: a};
};
var author$project$View$Exercise$viewSubjectSelect = function (model) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rundis$elm_bootstrap$Bootstrap$Form$Select$onChange(author$project$View$Exercise$SubjectSelect)
							]),
...
var author$project$View$Exercise$NumberInVariant = function (a) {
	return {$: 'NumberInVariant', a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(radio_.label)
					]))
			]));
};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('Уровень сложности')
								])),
...
var author$project$View$Exercise$viewPdf = function (path) {
	var url = 'https://olymp.bmstu.ru/exercises/files/' + path;
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Перечислите тэги через запятую')
							]))
					]))
			]));
};
...
var rundis$elm_bootstrap$Bootstrap$Grid$Col$md9 = A2(rundis$elm_bootstrap$Bootstrap$Grid$Internal$width, rundis$elm_bootstrap$Bootstrap$General$Internal$MD, rundis$elm_bootstrap$Bootstrap$Grid$Internal$Col9);
var author$project$View$Exercise$viewExercise = F2(
	function (model, exercise) {
		return A2(
			rundis$elm_bootstrap$Bootstrap$Grid$container,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2(author$project$View$Exercise$viewControls, model, exercise)
								])),
							A2(
							rundis$elm_bootstrap$Bootstrap$Grid$col,
							_List_fromArray(
								[rundis$elm_bootstrap$Bootstrap$Grid$Col$md9]),
							_List_fromArray(
								[
									author$project$View$Exercise$viewPdf(exercise.filename)
								]))
						])),
					A2(
					rundis$elm_bootstrap$Bootstrap$Grid$row,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											rundis$elm_bootstrap$Bootstrap$Button$onClick(author$project$View$Exercise$UpdateExercise)
										]),
									_List_fromArray(
										[
...
var author$project$View$Exercise$viewWExercise = function (model) {
	var _n0 = model.exercise;
	switch (_n0.$) {
		case 'NotAsked':
			return elm$html$Html$text('Выберите задание');
		case 'Loading':
...
var author$project$View$Exercise$view = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Grid$container,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$View$Exercise$viewSubjectSelect(model),
								author$project$View$Exercise$viewGradeSelect(model),
								author$project$View$Exercise$viewExerciseList(model)
							])),
						A2(
						rundis$elm_bootstrap$Bootstrap$Grid$col,
						_List_fromArray(
						...
						_List_fromArray(
							[
								author$project$View$Exercise$viewWExercise(model)
							]))
					])),
				A2(
				...
				A3(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Events$onClick(author$project$View$Exercise$CloseModal)
										]))
								]),
							_List_fromArray(
								[
					...
					A3(
						...
						A3(
							...
							_List_fromArray(
								[
									elm$html$Html$text('Сообщение')
								]),
							A2(
								rundis$elm_bootstrap$Bootstrap$Modal$hideOnBackdropClick,
								true,
								rundis$elm_bootstrap$Bootstrap$Modal$small(
									rundis$elm_bootstrap$Bootstrap$Modal$config(author$project$View$Exercise$CloseModal)))))))
			]));
};
...
var author$project$Moder$view = function (model) {
	return {
		body: _List_fromArray(
			[
				author$project$Moder$viewNavbar(model),
				A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$map,
						author$project$Moder$ExerciseMsg,
						author$project$View$Exercise$view(model.exercise))
					]))
			]),
		title: 'Модерирование'
	};
...
var author$project$Moder$main = elm$browser$Browser$document(
	{init: author$project$Moder$init, subscriptions: author$project$Moder$subscriptions, update: author$project$Moder$update, view: author$project$Moder$view});
_Platform_export({'Moder':{'init':author$project$Moder$main(
	A2(
		elm$json$Json$Decode$andThen,
		function (token) {
			return elm$json$Json$Decode$succeed(
